...
const int nSubstrate = ((numberOfSubstrateLayers+0.0)*nsl); //number of thin slices in substrate
const int npRC = 500;					    //number of points to calculate rocking curves
